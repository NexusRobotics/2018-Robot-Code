...
public class Robot extends TimedRobot implements PIDOutput{
	...
	/*	if (currentupmode==Upmode.me) {
		...
		//1frontleft, 2fbackleft, 13backright, 14frontright
		double currentLeftFront = pdp.getCurrent(1);
		double currentLeftBack = pdp.getCurrent(2);
		double currentRightFront = pdp.getCurrent(14);
		double currentRightBack = pdp.getCurrent(13);
		
		SmartDashboard.putNumber("currentLeftFront", currentLeftFront);
		SmartDashboard.putNumber("currentLeftBack", currentLeftBack);
		SmartDashboard.putNumber("currentRightFront", currentRightFront);
		SmartDashboard.putNumber("currentRightBack", currentRightBack);
		
		
		double inputLeftFront = drivetrain.leftFront.get();
		double inputLeftBack = drivetrain.leftBack.get();
		double inputRightFront = drivetrain.rightFront.get();
		double inputRightBack = drivetrain.rightBack.get();
		
		SmartDashboard.putNumber("inputLeftFront", inputLeftFront);
		SmartDashboard.putNumber("inputLeftBack", inputLeftBack);
		SmartDashboard.putNumber("inputRightFront", inputRightFront);
		SmartDashboard.putNumber("inputRightBack", inputRightBack);
